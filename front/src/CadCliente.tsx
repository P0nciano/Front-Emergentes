...
export default function CadCliente() {
    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900 min-h-screen flex justify-center pt-10">
            <div className="flex flex-col items-center px-6 py-2 w-full min-h-[60vh]">
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" 
                          onSubmit={handleSubmit(cadastraCliente)}>
                            ...
                            <button type="submit" className="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-400 dark:hover:bg-blue-500 dark:focus:ring-blue-800">Criar sua Conta</button>
